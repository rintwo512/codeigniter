...
<body>
    ...
    <form class="form" action="<?= base_url('auth'); ?>" method="post">
        <div class="box">
            ...
            <input type="text" value="<?= set_value('email'); ?>" placeholder="Username" name="email" required oninvalid="this.setCustomValidity('Masukan Username Anda !')" oninput="setCustomValidity('')" autocomplete="off">
            <!-- <?= form_error('email', '<small class="text-default pl-5">', '</small>'); ?> -->

            <div>
                <input type="password" name="password" placeholder="********" required oninvalid="this.setCustomValidity('Masukan Password Anda !')" oninput="setCustomValidity('')">
