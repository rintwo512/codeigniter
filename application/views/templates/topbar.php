            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                        ...
                                        <li>
                                            ...
                                            <?php foreach ($log as $lo) : ?>
                                                <?php if ($lo['user_login'] == "online") : ?>
                                                    <a href="#">
                                                        <div class="pull-left">
                                                            <img src="<?= base_url('asset/dist/img/') . $lo['foto']; ?>" class="img-circle" alt="User Image">
                                                        </div>
                                                        <h4>
                                                            <?= $lo['nama']; ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="#" data-toggle="modal" data-target="#modal-default" class="btn btn-danger">Keluar</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#" style="color: black" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
                        </li>
                    </ul>
                </div>
            </nav>
